...
export default function watcherAPI(instance: AxiosInstance) {
  return {
    ...
    watchResources: async (lrvs: LastResourceVersions) => {
      try {
        const queries = `podsLastResourceVersion=${lrvs.pods}&nodesLastResourceVersion=${lrvs.nodes}&pvsLastResourceVersion=${lrvs.pvs}&pvcsLastResourceVersion=${lrvs.pvcs}&scsLastResourceVersion=${lrvs.storageClasses}&pcsLastResourceVersion=${lrvs.priorityClasses}&namespaceLastResourceVersion=${lrvs.namespaces}&deploymentLastResourceVersion=${lrvs.deployments}`;
